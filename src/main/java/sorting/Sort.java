    ...
    public static void main( String [ ] args )
    {
        ...
        for(int k=1;k<=10;++k)
        {
            ...
            for( int i = 0; i < a.length; i++ )
                a[i] = (long) rand.nextInt(NUM_ITEMS * 5);

            //Start: AK: ACC assgn2

            System.out.println("--------Sorting 100,000 random integers--------");
            ...
            System.out.println("Time taken for Merge Sort:"+totalTime+ " ms.");
            //Merge Sort

            Long [ ] b = new Long[ NUM_ITEMS ];
            for( int i = 0; i < b.length; i++ )
                b[i] = (long) rand.nextInt(NUM_ITEMS * 5);

            startTime = System.currentTimeMillis();
            Sort.quicksort(b);
            endTime = System.currentTimeMillis();
            totalTime = (endTime - startTime);
            System.out.println("Time taken for Quick Sort:"+totalTime+ " ms.");
            //Quick Sort

            Long [ ] c = new Long[ NUM_ITEMS ];
            for( int i = 0; i < c.length; i++ )
                c[i] = (long) rand.nextInt(NUM_ITEMS * 5);

            startTime = System.currentTimeMillis();
            Sort.heapsort(c);
            endTime = System.currentTimeMillis();
            totalTime = (endTime - startTime);
            System.out.println("Time taken for Heap Sort:"+totalTime+ " ms.");
            //Heap Sort

            Long [ ] d = new Long[ NUM_ITEMS ];
            for( int i = 0; i < d.length; i++ )
                d[i] = (long) rand.nextInt(NUM_ITEMS * 5);

            startTime = System.currentTimeMillis();
            Arrays.sort(d);
            endTime = System.currentTimeMillis();
            totalTime = (endTime - startTime);
            System.out.println("Time taken for double pivot Quick Sort:"+totalTime+ " ms.");
